...
ggplot(murder, aes(state, murders_2014)) +
  ...
  annotate("text", x="Illinois", y=468, label="Chicago, IL") +
  annotate("text", x="Maryland", y=334, label="Baltimore, MD") +
  annotate("text", x="New York", y=372, label="New York, NY") +
  annotate("text", x="Michigan", y=285, label="Detriot, MI") +
  annotate("text", x="Texas", y=313, label="Houston, TX") +
