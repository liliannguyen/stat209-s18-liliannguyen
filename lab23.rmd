...
**Answer**: Most crimes do not result in an arrest. 
...
**Answer**: A little less than 3 thefts out of 10 were considered a crime. 
...
**Answer**: 38816 thefts were considered to be crimes. 
...
**Answer**: There are approximately 36.55238 thefts that are considered to be crimes per 1000 households. 
...
**Answer**: It is larger. Yes, becuase they are both the averages of the sets of data. This means that there is a larger percentage of arrest in Humboldt Park than for the entire Chicago area. 
...
**Answer**: This is smaller. Yes, again, becuase these are both calculating the average and therefore, the size of the dataset is accounted for. This means that for the Humboldt Park area, there is less thefts that are considered crimes when compared to the percentage of the greater Chicago area. 
...
**Answer**: This is larger than the rate of crime for the entire dataset. We can compare the two because this is the crime rates out of 1000 households. This means there is more crimes in the Humboldt Park area per 1000 households than the rate for the entire dataset. 
...
**Answer**: The higher the median income, the lower the rate of theft. The theft rates were highest for the income range of 20000 and 40000. Yes, there are  outliers, where the theft rate was greater than 1. 
...
**Answer**: gentrification and it is a community area
