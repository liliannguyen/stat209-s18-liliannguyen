...
**Answer**: No. There are a significant number of points that are outside of the range. Especially for the base salaries above the range, which shifts the range to the right. 
...
**Answer**: The 80% gives the probability that the how likely the age would be to that approximate mean would be in the range of 33.07 and 34.65 again. 
