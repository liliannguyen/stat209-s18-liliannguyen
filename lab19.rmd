...
**Answer**: Yes, it has a higher rating, even when using the confidence interveral.  
...
**Answer**: because the people probably looked up restaurants on Yelp before going to try them. This is because the sample is likely biased. No one wants food poisoning. 
...
**Answer**: 0.05699 is the slope coefficient for the restaurants that do have chips included. 
...
**Answer**: Restaurants that have chips included are not signicantly statistically more likely to have higher Yelp scores. 
...
**Answer**: Yes, but it is not statistically siginificant. 
...
**Answer**: Yes. The overall score is higher for that of high synergy than the last. 
