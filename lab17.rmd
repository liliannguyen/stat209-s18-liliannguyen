...
**Answer**: 34.5. It means that 30% of the cereals had a score less than 34.5. 
...
**Answer**: The score increased as the number of reviews increased.
...
**Answer**: 30. This means that 80% of the teas were below 30 cents 
...
**Answer**: The most expensive teas have the least amount of reviews. 
...
**Answer**: Matcha had the lowest mean score with the highest score. It also had the least amount of types.
